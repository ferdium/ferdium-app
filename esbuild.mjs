...
const runEsbuild = async () => {
  ...
  //Scss entry points
  entryPoints.push("src/styles/main.scss", "src/styles/vertical.scss", "src/styles/animations.scss");
  ...
  if (watch) {
    ...
    log(chalk.green(`Completed build in ${moment(duration).format("ss.m")}sec`))
  }
};
