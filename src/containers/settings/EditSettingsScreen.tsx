...
const messages = defineMessages({
  ...
  twoFactorAutoCatcher: {
    ...
    defaultMessage: 'Auto catch two-factor codes from notifications',
  },
  twoFactorAutoCatcherArray: {
    id: 'settings.app.form.twoFactorAutoCatcherArray',
    defaultMessage:
      'Comma seperated and case insensitive words/expressions to catch catch two-factor codes from. Ex.: token, code, sms, verify',
  },
